    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                DollarValueItem(
                    title = "USDT",
                    value = dollar.dollarUsdt ?: "N/A",
                    color = Color(0xFF4CAF50) // Verde para diferenciar
                )

                DollarValueItem(
                    title = "USDC",
                    value = dollar.dollarUsdc ?: "N/A",
                    color = Color(0xFF03A9F4) // Azul para diferenciar
                )
            }
    ...
    Card(
        ...
        Column(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                Text(text = "Oficial: $${dollar.dollarOfficial ?: "N/A"}")
                Text(text = "Paralelo: $${dollar.dollarParallel ?: "N/A"}")
                Text(text = "USDT: $${dollar.dollarUsdt ?: "N/A"}")
                Text(text = "USDC: $${dollar.dollarUsdc ?: "N/A"}")
            }
        }
    }
}
